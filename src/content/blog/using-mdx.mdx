---
title: 'Using MDX'
description: 'Learn how to use MDX in Terminote to embed interactive components and JSX in your Markdown content.'
pubDate: 'Feb 13 2025'
heroImage: '../../assets/blog-placeholder-5.jpg'
---

**Terminote** supports MDX (Markdown + JSX), allowing you to embed interactive components directly in your blog posts. This guide covers how to use MDX effectively in your terminal-themed blog.
